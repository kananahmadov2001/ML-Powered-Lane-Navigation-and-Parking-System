...
Kp = 2.0                                   # Proportional gain for converting offset to steering angle
...
def classify_lanes_live(low_threshold, high_threshold):
    ...
    while True:
        ...
        if left_lines and right_lines:
            ...
            steering_angle = Kp * offset_cm
            steering_angle = np.clip(steering_angle, -30, 30)  # Clamp to servo-safe range
            ...
            if current_time - last_print_time >= 0.5:
                ...
                print(f"[INFO] Suggested Steering Angle: {steering_angle:.2f}°\n")
